class Enigma
  ...
  # end
  #
  # def total_msg(message)
  #   special_chars(message).each do |char, index|
  #     if index <= shifted_hash_to_msg(message).size
  #       shifted_hash_to_msg(message).insert(index, char)
  #     elsif index > shifted_hash_to_msg(message).size
  #       shifted_hash_to_msg(message) << char
